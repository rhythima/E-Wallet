    ...
    return(
      <View style={{flexDirection:'row',marginVertical:SIZES.padding*2}}>
       <View style={{flex:1}}>
        ...
        <Text style={{...FONTS.body2,color:COLORS.gray}}>Welcome to Wallie</Text>
       </View>
...
<View style={{
  ...
  marginBottom:5,
  borderRadius:20,
  backgroundColor:item.backgroundColor, //how
  alignItems:'center',
  justifyContent:'center'
}}>
<Image
    ...
    const renderPromoHeader=()=>(
      <View style={{flexDirection:'row', marginBottom:SIZES.padding}}>
        ...
        <TouchableOpacity onPress={()=>console.log('View All')}>
          <Text style={{color:COLORS.gray, ...FONTS.body4, fontWeight:'bold'}}>View All</Text>
        </TouchableOpacity>
      </View>
    )
